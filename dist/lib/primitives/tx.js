...
export class TX {
    ...
    fromOptions(options) {
        ...
        if (options.time != null) {
            assert((options.time >>> 0) === options.time, 'time must be a uint32.');
    ...
    checkInput(index, coin, flags) {
        ...
        Script.verify(input.script, coin.script, this, index, coin.value, flags);
    }
    /**
     ...
     * @returns {TX}
     */
    static fromReader(br, block = null) {
