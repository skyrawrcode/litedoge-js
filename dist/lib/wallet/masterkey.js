 ...
 * @default
 */
export var MasterKeyAlg;
(function (MasterKeyAlg) {
    MasterKeyAlg[MasterKeyAlg["PBKDF2"] = 0] = "PBKDF2";
    MasterKeyAlg[MasterKeyAlg["SCRYPT"] = 1] = "SCRYPT";
})(MasterKeyAlg || (MasterKeyAlg = {}));
;
