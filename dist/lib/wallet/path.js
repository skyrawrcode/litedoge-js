...
(function (pathTypes) {
    pathTypes[pathTypes["HD"] = 0] = "HD";
    pathTypes[pathTypes["KEY"] = 1] = "KEY";
    pathTypes[pathTypes["ADDRESS"] = 2] = "ADDRESS";
})(pathTypes || (pathTypes = {}));
;
/**
 * Path
...
export class Path {
    ...
    fromAddress(account, address) {
        this.keyType = pathTypes.ADDRESS;
