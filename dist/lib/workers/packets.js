/*!
 * packets.js - worker packets for ldogejs
...
(function (packetTypes) {
    packetTypes[packetTypes["ENV"] = 0] = "ENV";
    packetTypes[packetTypes["EVENT"] = 1] = "EVENT";
    packetTypes[packetTypes["LOG"] = 2] = "LOG";
    packetTypes[packetTypes["ERROR"] = 3] = "ERROR";
    packetTypes[packetTypes["ERRORRESULT"] = 4] = "ERRORRESULT";
    packetTypes[packetTypes["CHECK"] = 5] = "CHECK";
    packetTypes[packetTypes["CHECKRESULT"] = 6] = "CHECKRESULT";
    packetTypes[packetTypes["SIGN"] = 7] = "SIGN";
    packetTypes[packetTypes["SIGNRESULT"] = 8] = "SIGNRESULT";
    packetTypes[packetTypes["CHECKINPUT"] = 9] = "CHECKINPUT";
    packetTypes[packetTypes["CHECKINPUTRESULT"] = 10] = "CHECKINPUTRESULT";
    packetTypes[packetTypes["SIGNINPUT"] = 11] = "SIGNINPUT";
    packetTypes[packetTypes["SIGNINPUTRESULT"] = 12] = "SIGNINPUTRESULT";
    packetTypes[packetTypes["ECVERIFY"] = 13] = "ECVERIFY";
    packetTypes[packetTypes["ECVERIFYRESULT"] = 14] = "ECVERIFYRESULT";
    packetTypes[packetTypes["ECSIGN"] = 15] = "ECSIGN";
    packetTypes[packetTypes["ECSIGNRESULT"] = 16] = "ECSIGNRESULT";
    packetTypes[packetTypes["MINE"] = 17] = "MINE";
    packetTypes[packetTypes["MINERESULT"] = 18] = "MINERESULT";
    packetTypes[packetTypes["SCRYPT"] = 19] = "SCRYPT";
    packetTypes[packetTypes["SCRYPTRESULT"] = 20] = "SCRYPTRESULT";
...
export class CheckInputPacket extends Packet {
    ...
    getSize() {
        ...
        size += encoding.sizeVarintBI(this.coin.value);
    ...
    toWriter(bw) {
        ...
        bw.writeVarintBI(this.coin.value);
    ...
    fromRaw(data) {
        ...
        this.coin.value = br.readVarintBI();
