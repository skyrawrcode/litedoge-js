/*!
 * indexer.js - abstract interface for ldogejs indexers
...
export class Indexer extends EventEmitter {
  ...
  async verifyNetwork(): Promise<any> {
  ...
  async getEntry(hash): Promise<any> {
  ...
  async getBlockMeta(height): Promise<any> {
  ...
  async _rollforward(): Promise<any> {
  ...
  async _rollback(height: number): Promise<any> {
    if (height > this.height) {
      this.logger.warning(
  ...
  async _addBlock(meta: BlockMeta, block: Block, view: CoinView): Promise<any> {
  ...
  async indexBlock(meta: BlockMeta, block: Block, view: CoinView): Promise<any> {
    ;
  }
  ...
  async unindexBlock(meta: BlockMeta, block: Block, view: CoinView): Promise<any> {
    ;
  }
  ...
  async _removeBlock(meta: BlockMeta, block: Block, view: CoinView): Promise<any> {
    const start = util.bench();
  ...
  async _setTip(meta): Promise<any> {
    if (meta.height < this.height) {
