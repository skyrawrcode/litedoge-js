/*!
 * txindexer.js - transaction indexer for ldogejs
...
class BlockRecord {
  ...
  constructor(options: { block?: Buffer, time?: number } = {}) {
...
class TxRecord {
  ...
  constructor(options: { height?: number, index?: number, offset?: number, length?: number } = {}) {
...
export class TXIndexer extends Indexer {
  /**
   * Create a indexer
   * @constructor
   ...
   * @param {Hash} hash
   * @returns {Promise<TXMeta>} - Returns {@link TXMeta}.
   */
