/*!
 * mempool.js - mempool for ldogejs
...
import {Address, Coin, Outpoint, TX, TXMeta} from '../primitives/index.js'
import {MempoolEntry} from './mempoolentry.js';
import {layout} from './layout.js';
import {AddrIndexer} from './addrindexer.js';
import {PolicyEstimator} from './fees.js';
import {CoinView} from '../coins/coinview.js';
import {WorkerPool} from '../workers/index.js';
import {Chain, common} from '../blockchain/index.js';
...
export class Mempool extends EventEmitter {
  ...
  async verify(entry, view: CoinView) {
    ...
    if (this.options.rejectAbsurdFees && entry.fee > minFee * 10000n)
